 ...
 *
 *   // network
 *   CHashRentalCoinNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.hashrentalcoin.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CHashRentalCoinNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CHashRentalCoinNetwork(UniValue objIn)
    {
...
// // can be under: HashRentalCoinNetwork
// //   -- signature requirements : Key1(User)
// class CHashRentalCoinNetworkVariable : public CGovernanceObject
// {
// private:
...
//     //     return (IsType() == HashRentalCoinNetwork);
//     // }
