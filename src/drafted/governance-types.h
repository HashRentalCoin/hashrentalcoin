...
enum GovernanceObjectType {
    ...
    // -------------------------------
    // HashRentalCoinNetwork - is the root node
    HashRentalCoinNetwork = 1000,
    HashRentalCoinNetworkVariable = 1001,
    Category = 1002,
    ...
    //   --  hashrentalcoin that operate DAOs will own companies which can own things legally
    Group = 2000,
    User = 2001,
    Company = 2002,
