...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "HashRentalCoinNetwork") type = HashRentalCoinNetwork;
    if(strType == "HashRentalCoinNetworkVariable") type = HashRentalCoinNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == HashRentalCoinNetwork) s = "HashRentalCoinNetwork";
    if(type == HashRentalCoinNetworkVariable) s = "HashRentalCoinNetworkVariable";
