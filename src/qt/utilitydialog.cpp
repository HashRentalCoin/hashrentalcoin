    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("HashRentalCoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About HashRentalCoin Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  hashrentalcoin-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the HashRentalCoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
PrivateSend uses an innovative process to mix your inputs with the inputs of two other hashrentalcoin, without having your coins ever leave your wallet. \
...
These denominations are 0.01 HARC, 0.1 HARC, 1 HARC and 10 HARC -- sort of like the paper money you use every day.</li> \
...
<li>When two other hashrentalcoin send similar messages, indicating that they wish to mix the same denomination, a mixing session begins. \
...
For more info see <a href=\"https://HashRentalCoinDev.atlassian.net/wiki/display/DOC/PrivateSend\">https://HashRentalCoinDev.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("HashRentalCoin Core is shutting down...") + "<br /><br />" +
