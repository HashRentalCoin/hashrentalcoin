    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("HashRentalCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a HashRentalCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and hashrentalcoin: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About HashRentalCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about HashRentalCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for HashRentalCoin Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your HashRentalCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified HashRentalCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a hashrentalcoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the HashRentalCoin Core help message to get a list with possible HashRentalCoin Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("HashRentalCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to HashRentalCoin network", "", count));
    } else {
...
{
    QString strTitle = tr("HashRentalCoin Core"); // default title
    ...
    // Append title to "HashRentalCoin Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
