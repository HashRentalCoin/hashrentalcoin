    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("HARC-light"), QVariant("light"));
    ui->theme->addItem(QString("HARC-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("HARC-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("HARC-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("HARC-traditional"), QVariant("trad"));
