...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("HashRentalCoin Core hashrentalcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  hashrentalcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded hashrentalcoin transaction") + "\n" +
              "  hashrentalcoin-tx [options] -create [commands]   " + _("Create hex-encoded hashrentalcoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded hashrentalcoin transaction
