...
Only requiring some minor changes is hashrentalcoin.cpp.
...
Changes to hashrentalcoin.cpp
----------------------
hashrentalcoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
