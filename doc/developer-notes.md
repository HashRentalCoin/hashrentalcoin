...
HashRentalCoin Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as HashRentalCoin Core, where everyone uses
...
pay attention to for reviewers of HashRentalCoin Core code.

General HashRentalCoin Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: HashRentalCoin Core uses tinyformat, which is type safe. Leave them out to avoid confusion
