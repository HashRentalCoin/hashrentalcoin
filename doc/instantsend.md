...
This mechanism has been integrated into Bitcore-Node-HashRentalCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/hashrentalcoinproject/insight-api-hashrentalcoin#web-socket-api](https://github.com/hashrentalcoinproject/insight-api-hashrentalcoin#web-socket-api)
* API: [https://github.com/hashrentalcoinproject/insight-api-hashrentalcoin#instantsend-transactions](https://github.com/hashrentalcoinproject/insight-api-hashrentalcoin#instantsend-transactions)
...
By default, the HashRentalCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the HashRentalCoin Core daemon:
